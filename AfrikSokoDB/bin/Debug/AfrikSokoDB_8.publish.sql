...
GO
PRINT N'Creating Table [dbo].[FavoriteProductType]...';
...
CREATE TABLE [dbo].[FavoriteProductType] (
    ...
    [AppUserId]  INT NULL,
    [ProdtypeId] INT NULL,
    CONSTRAINT [PK_FavoriteProdType] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
GO
PRINT N'Creating Table [dbo].[SupplyItems]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[SupplyItems]...';


GO
ALTER TABLE [dbo].[SupplyItems]
    ADD DEFAULT GetDate() FOR [PostedDate];
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_FavoriteProdType_User]...';


GO
ALTER TABLE [dbo].[FavoriteProductType]
    ADD CONSTRAINT [FK_FavoriteProdType_User] FOREIGN KEY ([AppUserId]) REFERENCES [dbo].[AppUser] ([Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_FavoriteProdType_ProductType]...';


GO
ALTER TABLE [dbo].[FavoriteProductType]
    ADD CONSTRAINT [FK_FavoriteProdType_ProductType] FOREIGN KEY ([ProdtypeId]) REFERENCES [dbo].[ProductType] ([Id]);
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_SupplyItems_AppUser]...';


GO
ALTER TABLE [dbo].[SupplyItems]
    ADD CONSTRAINT [FK_SupplyItems_AppUser] FOREIGN KEY ([UserId]) REFERENCES [dbo].[AppUser] ([Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_SupplyItems_Product]...';


GO
ALTER TABLE [dbo].[SupplyItems]
    ADD CONSTRAINT [FK_SupplyItems_Product] FOREIGN KEY ([ProductId]) REFERENCES [dbo].[Product] ([Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_SupplyItems_ProdType]...';


GO
ALTER TABLE [dbo].[SupplyItems]
    ADD CONSTRAINT [FK_SupplyItems_ProdType] FOREIGN KEY ([ProductTypeId]) REFERENCES [dbo].[ProductType] ([Id]);
...
CREATE VIEW [dbo].[V_AppUser]
	AS SELECT u.Id, u.Email, u.FirstName, u.LastName, u.NickName, r.RoleName AS Role FROM AppUser u 
	JOIN AppRole r ON r.Id = u.RoleId
GO
PRINT N'Creating View [dbo].[V_FavoriteProdType]...';
...
GO
PRINT N'Creating View [dbo].[V_ProductMain]...';
...
AS
	...
	END
GO
PRINT N'Creating Procedure [dbo].[AddSupplyItem]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[DeleteSupplyItem]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[UpdateAddress]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[UpdateSupplyItem]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'bac77762-0afe-451a-9431-507eef454f23')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('bac77762-0afe-451a-9431-507eef454f23')

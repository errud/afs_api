...
AS
BEGIN
	UPDATE Supplier SET UserId = @userid, Company = @company, Logo = @logo, SectorId = @secId, ServiceId = @serId, Membership = 0, Contact = @contact, Phone = @phone, Email = @email, [Url] = @url,  [Address] = @address, City = @city,	Country = @ctry, AdditInfo = @ainfo, [Status] = 1, Created = Getdate()
	WHERE Id = @id
END
GO
